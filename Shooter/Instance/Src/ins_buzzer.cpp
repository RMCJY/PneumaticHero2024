 ...
 * @Date: 2024-06-30 16:29:36
 * @LastEditors: RMCJY 1409947012@qq.com
 * @LastEditTime: 2024-06-30 16:36:37
 * @FilePath: \Shooter\Instance\Src\ins_buzzer.cpp
...
hw_buzzer::Buzzer* CreateBuzzer(void)
{
  ...
  if (unique_buzzer_ptr == nullptr) {
    unique_buzzer_ptr = new hw_buzzer::Buzzer(&htim4, TIM_CHANNEL_3, hw_buzzer::kPlayConfigSinglePlayback, &kTuneListInfo);
  }
